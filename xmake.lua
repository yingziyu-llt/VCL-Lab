...
target("ray-tracing")
    set_kind("binary")
    add_deps("lab-common")
    add_headerfiles("src/VCX/Labs/RayTracing/*.h")
    add_headerfiles("src/VCX/Labs/RayTracing/*.hpp")
    add_files      ("src/VCX/Labs/RayTracing/*.cpp")
    after_build(function (target)
        os.cp("src/VCX/Labs/RayTracing/shaders/*", path.join(target:targetdir(), "assets", "shaders"))
    end)
    after_install(function (target)
        os.cp("src/VCX/Labs/RayTracing/shaders/*", path.join(target:installdir(), "bin", "assets", "shaders"))
    end)
